...
<body id="gallery_body">
    ...
    <main class="content">
        ...
        <ul id="photos_position">
            ...
            <!-- diplay source if applicable -->
            <div class="gallery_captions"><?php echo htmlspecialchars($entry["description"]);
                                            if (!$entry["source"] == NULL) {
                                            ?>

                    <cite><a href="<?php echo htmlspecialchars($entry["source"]) ?>"> / Source: Cornell Athletics></a></cite>
                <?php
                                            }
                ?>
    ...
    <!-- function to reveal the upload form when the button is clicked -->
    <script>
